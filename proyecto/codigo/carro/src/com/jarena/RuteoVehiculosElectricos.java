...
public class RuteoVehiculosElectricos {
     ...
     * @param tiempoSolucion
     */
    public void imprimirSolucion(double tiempoSolucion,String archivo)
    {
        //TODO: Aqui debe imprimir el resultado final
        System.out.println("Archivo procesado: " + archivo);
        System.out.println("RuteoVehiculosElectricos{" + "r=" + r + ", speed=" + speed + ", Tmax=" + Tmax + ", Smax=" + Smax + ", st_customer=" + st_customer + ", Q=" + Q + ", tiempoSolucion=" + tiempoSolucion + '}');
        System.out.println("Clientes visitados:"+ clientes + " Rutas: "+ numRutas + " Tiempo:" + tiempo);
        System.out.println("---------------------------------------------------------------------------");
    }
